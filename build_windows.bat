@echo off
REM Build BungVision Label Studio on Windows.
REM
...
REM
REM Output:
REM   dist\BungVisionLabelStudio\BungVisionLabelStudio.exe
REM   installer\BungVisionLabelStudio-<version>-<edition>-setup.exe
...
echo ==========================================================
echo   BungVision Label Studio -- %EDITION% build
echo ==========================================================
...
echo ==========================================================
echo   App: dist\BungVisionLabelStudio\BungVisionLabelStudio.exe
