...
#define AppName "BungVision Label Studio"
#define AppExeName "BungVisionLabelStudio.exe"
#define AppPublisher "BungVision"
...
OutputDir=.
OutputBaseFilename=BungVisionLabelStudio-{#AppVersion}-{#Edition}-setup
SetupIconFile=..\bung_labeler\ui\assets\app.ico
...
Source: "..\dist\BungVisionLabelStudio\*"; DestDir: "{app}"; \
...
; captures/labels/exports live in %LOCALAPPDATA%\BungVisionLabelStudio and are
...
FinishedLabel=Setup has installed {#AppName} on your computer.%n%nYour captures, labels and exports are stored in:%n%%LOCALAPPDATA%%\BungVisionLabelStudio\data%n%nThis folder is kept when you uninstall or upgrade.
