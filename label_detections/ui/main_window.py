...
class MainWindow(QMainWindow):
    ...
    def _help_tab(self) -> QWidget:
        ...
        body.setPlainText(
            ...
            "\n"
            "The two-stage idea\n"
            "The model is trained on a handful of coarse FAMILIES that stay stable for\n"
            "years: battery_side, spec_plate, warning_label, cert_mark, trace_tag,\n"
            "promo_label, code_patch.\n"
            "Which exact label a detection IS -- artwork, revision, part number -- is\n"
            "resolved afterwards from the label library, by decoding its code and\n"
            "matching its artwork.\n"
            "That is why a new label SKU costs a library row and a dataset, not a\n"
            "retrain of everything else. Never add a class per SKU.\n"
            "\n"
