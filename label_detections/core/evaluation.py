...
Evaluation runs ``label_detections.eval_runner`` (a thin Ultralytics wrapper) which
...
METRICS_START = "<<<LABELVISION_METRICS_JSON>>>"
METRICS_END = "<<<END_LABELVISION_METRICS_JSON>>>"

RUNNER_MODULE = "label_detections.eval_runner"
