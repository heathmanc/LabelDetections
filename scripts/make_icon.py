#!/usr/bin/env python3
"""Generate the LabelVision Studio application icon.
...
PyInstaller's resource embedder and every Windows version handle reliably.
    ...
    python scripts/make_icon.py                 # -> label_detections/ui/assets/app.ico
...
def main() -> int:
    ...
    ap.add_argument("--out", default="label_detections/ui/assets/app.ico")
